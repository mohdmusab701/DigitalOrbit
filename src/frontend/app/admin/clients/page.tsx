    ...
    <div className="p-4 sm:p-8 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="hidden sm:flex items-center gap-2 px-4 py-2.5 bg-white dark:bg-dark-card border border-slate-200 dark:border-dark-border text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-white/5 rounded-xl transition-colors text-sm font-medium shadow-sm"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
        <div className="bg-white dark:bg-dark-card border border-slate-200 dark:border-dark-border rounded-xl p-5 shadow-sm flex items-center gap-4">
          ...
          <div>
            <p className="text-xs font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wide">Total Clients</p>
      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-6">
        ...
        <div className="relative">
          ...
          <select
            ...
            className="pl-10 pr-10 py-2.5 bg-white dark:bg-dark-card border border-slate-200 dark:border-dark-border rounded-xl text-sm text-slate-700 dark:text-slate-300 appearance-none cursor-pointer focus:outline-none focus:ring-2 focus:ring-primary-500/30 focus:border-primary-500 transition-all min-w-[160px]"
          >
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse whitespace-nowrap">
              ...
              <tbody className="divide-y divide-slate-100 dark:divide-dark-border">
                {clients.map((client) => (
                  <tr key={client._id} className="hover:bg-slate-50 dark:hover:bg-white/[0.02] transition-colors group">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-2.5 bg-white dark:bg-dark-bg border rounded-xl text-sm text-slate-900 dark:text-white placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-primary-500/30 focus:border-primary-500 transition-all ${
                    formErrors.name ? "border-red-300 dark:border-red-700" : "border-slate-200 dark:border-dark-border"
                  }`}
                />
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-10 pr-4 py-2.5 bg-white dark:bg-dark-bg border rounded-xl text-sm text-slate-900 dark:text-white placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-primary-500/30 focus:border-primary-500 transition-all ${
                      formErrors.email ? "border-red-300 dark:border-red-700" : "border-slate-200 dark:border-dark-border"
                    }`}
                  />
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-10 pr-4 py-2.5 bg-white dark:bg-dark-bg border rounded-xl text-sm text-slate-900 dark:text-white placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-primary-500/30 focus:border-primary-500 transition-all ${
                        formErrors.phone ? "border-red-300 dark:border-red-700" : "border-slate-200 dark:border-dark-border"
                      }`}
                    />
                  </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-10 pr-4 py-2.5 bg-white dark:bg-dark-bg border rounded-xl text-sm text-slate-900 dark:text-white placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-primary-500/30 focus:border-primary-500 transition-all ${
                        formErrors.company ? "border-red-300 dark:border-red-700" : "border-slate-200 dark:border-dark-border"
                      }`}
                    />
                  </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-10 pr-4 py-2.5 bg-white dark:bg-dark-bg border rounded-xl text-sm text-slate-900 dark:text-white placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-primary-500/30 focus:border-primary-500 transition-all ${
                      formErrors.address ? "border-red-300 dark:border-red-700" : "border-slate-200 dark:border-dark-border"
                    }`}
                  />
                </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <textarea
                    ...
                    rows={3}
                    className={`w-full pl-10 pr-4 py-2.5 bg-white dark:bg-dark-bg border rounded-xl text-sm text-slate-900 dark:text-white placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-primary-500/30 focus:border-primary-500 transition-all resize-none ${
                      formErrors.notes ? "border-red-300 dark:border-red-700" : "border-slate-200 dark:border-dark-border"
                    }`}
                  />
                </div>
                  ...
                  <button
                    ...
                    className={`flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-sm font-medium border transition-all ${
                      formData.status === "active"
                        ...
                        : "bg-white dark:bg-dark-bg border-slate-200 dark:border-dark-border text-slate-500 dark:text-slate-400 hover:border-green-300 dark:hover:border-green-700"
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-sm font-medium border transition-all ${
                      formData.status === "inactive"
                        ...
                        : "bg-white dark:bg-dark-bg border-slate-200 dark:border-dark-border text-slate-500 dark:text-slate-400 hover:border-red-300 dark:hover:border-red-700"
                    }`}
                  >
      ...
      {deleteModalId && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm">
          <div className="bg-white dark:bg-dark-card border border-slate-200 dark:border-dark-border rounded-2xl shadow-xl max-w-sm w-full p-6 animate-in fade-in zoom-in-95 duration-200">
            ...
            <h3 className="text-lg font-bold text-slate-900 dark:text-white text-center mb-2">Delete Client</h3>
