...
export default function ClientsPage() {
 ...
 className="hidden sm:flex items-center gap-2 px-4 py-2.5 bg-card border border-border text-muted-foreground hover:bg-slate-50 dark:hover:bg-white/5 rounded-xl transition-colors text-sm font-medium shadow-sm"
 >
