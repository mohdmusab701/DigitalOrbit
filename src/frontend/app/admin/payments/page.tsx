...
export default function AdminPaymentsPage() {
 ...
 <p className="text-sm text-muted-foreground ml-10">Manage invoices and track revenue.</p>
 </div>
 <button
 ...
 <div className="bg-card border border-yellow-100 dark:border-yellow-900/30 rounded-xl p-5 shadow-sm flex items-center gap-4">
 ...
 className="w-full pl-10 pr-4 py-2.5 bg-card border border-border rounded-xl text-sm text-foreground placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-primary-500/30"
 />
 {searchQuery && (
 ...
 className="pl-10 pr-10 py-2.5 bg-card border border-border rounded-xl text-sm text-muted-foreground appearance-none cursor-pointer focus:outline-none focus:ring-2 focus:ring-primary-500/30 min-w-[160px]"
 >
 ...
 <div>
 <label className="block text-sm font-medium text-muted-foreground mb-1.5">Client <span className="text-red-500">*</span></label>
 <select
 ...
 <div>
 <label className="block text-sm font-medium text-muted-foreground mb-1.5">Project <span className="text-red-500">*</span></label>
 <select
 ...
 <div>
 <label className="block text-sm font-medium text-muted-foreground mb-1.5">Amount <span className="text-red-500">*</span></label>
 <input
 type="number"
