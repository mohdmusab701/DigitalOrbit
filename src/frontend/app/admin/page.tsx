...
export default function AdminPage() {
 ...
 <p className="text-sm text-muted-foreground mt-1">Manage inbound leads and contact requests.</p>
 </div>
 ...
 <div className="bg-card border border-blue-100 dark:border-blue-900/30 rounded-xl p-4 shadow-sm flex flex-col items-center text-center">
 ...
 <div className="bg-card border border-yellow-100 dark:border-yellow-900/30 rounded-xl p-4 shadow-sm flex flex-col items-center text-center">
 ...
 <div className="bg-card border border-green-100 dark:border-green-900/30 rounded-xl p-4 shadow-sm flex flex-col items-center text-center">
 ...
 <div className="bg-card border border-red-100 dark:border-red-900/30 rounded-xl p-4 shadow-sm flex flex-col items-center text-center">
 ...
 <th className="px-6 py-4 text-xs font-semibold text-muted-foreground uppercase tracking-wider">Status & Date</th>
 ...
 <div className="text-sm text-muted-foreground line-clamp-2 max-w-sm" title={lead.message}>
 {lead.message}
 </div>
 </td>
 <td className="px-6 py-5">
 ...
 You are about to convert <strong className="text-muted-foreground">{convertModalLead.name}</strong> into a Client. You can optionally add more details below.
 </p>
 ...
 className="w-full px-4 py-2.5 bg-background border border-border rounded-xl text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-primary-500/30"
 />
 </div>
 <div>
 ...
 rows={3}
 className="w-full px-4 py-2.5 bg-background border border-border rounded-xl text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-primary-500/30 resize-none"
 />
 </div>
 </div>
 ...
 <h3 className="text-lg font-bold text-foreground text-center mb-2">Delete Lead</h3>
