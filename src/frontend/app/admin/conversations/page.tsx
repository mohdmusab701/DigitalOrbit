...
export default function AdminConversationsPage() {
 ...
 <p className="text-sm text-muted-foreground ml-10">Monitor chatbot conversations and convert leads.</p>
 </div>
 <button
 ...
 className="px-3 py-2.5 bg-card border border-border rounded-xl text-sm text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary-500/30"
 >
 ...
 <th className="text-left py-3.5 px-5 text-xs font-semibold text-muted-foreground uppercase tracking-wider">Visitor</th>
 <th className="text-left py-3.5 px-5 text-xs font-semibold text-muted-foreground uppercase tracking-wider">Last Message</th>
 <th className="text-left py-3.5 px-5 text-xs font-semibold text-muted-foreground uppercase tracking-wider">Messages</th>
 ...
 <td className="py-3.5 px-5 text-muted-foreground max-w-[200px] truncate">
 {conv.lastMessage || "—"}
 </td>
 <td className="py-3.5 px-5 text-muted-foreground">{conv.messageCount}</td>
 <td className="py-3.5 px-5">
 ...
 className="bg-card border border-border rounded-2xl shadow-2xl w-full max-w-lg max-h-[80vh] flex flex-col overflow-hidden"
 >
 {/* Modal Header */}
