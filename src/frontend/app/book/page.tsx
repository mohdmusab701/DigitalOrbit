    ...
    return (
      <div className="min-h-[80vh] flex items-center justify-center p-4">
        <motion.div 
          ...
          className="max-w-md w-full bg-white dark:bg-dark-card border border-slate-200 dark:border-dark-border rounded-2xl p-8 text-center shadow-xl"
        >
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12 lg:py-20">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-slate-900 dark:text-white mb-4">Book a Discovery Call</h1>
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="w-full lg:w-1/3">
          <div className="bg-slate-50 dark:bg-dark-card border border-slate-200 dark:border-dark-border rounded-2xl p-6 lg:p-8 sticky top-24">
            <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-6">Meeting Details</h3>
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  <p className="font-medium text-slate-900 dark:text-white">30 Minute Call</p>
                  <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Free consultation</p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Google Meet / Zoom / Phone</p>
                </div>
              </div>

              {selectedDate && selectedTime && (
                <div className="pt-6 border-t border-slate-200 dark:border-dark-border">
                  <h4 className="text-sm font-semibold text-slate-900 dark:text-white uppercase tracking-wider mb-3">Selected Time</h4>
                  ...
                  <p className="font-medium text-slate-700 dark:text-slate-300 mt-1 ml-6">
                    {selectedTime}
                  </p>
        ...
        <div className="w-full lg:w-2/3 bg-white dark:bg-dark-card border border-slate-200 dark:border-dark-border rounded-2xl p-6 lg:p-8 shadow-sm">
          {error && (
          ...
          <AnimatePresence mode="wait">
            {step === 1 ? (
              ...
              >
                <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">Select Date & Time</h2>
                ...
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="flex gap-2">
                    <button
                      onClick={prevWeek}
                      className="p-2 border border-slate-200 dark:border-dark-border rounded-lg hover:bg-slate-50 dark:hover:bg-white/5 transition-colors"
                    >
                        ...
                        className={`aspect-square rounded-xl flex flex-col items-center justify-center p-2 transition-all ${
                          disabled 
                            ...
                            : selected 
                              ...
                              : "bg-slate-50 dark:bg-dark-bg text-slate-900 dark:text-white hover:border-primary-500 border border-transparent"
                        }`}
                      >
                ...
                {selectedDate && (
                  ...
                  >
                    <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-4">Available Times</h3>
                      ...
                      {TIME_SLOTS.map((time) => (
                        <button
                          ...
                          className={`py-3 rounded-xl text-sm font-medium transition-all ${
                            selectedTime === time
                              ? "bg-primary-600 text-white shadow-md shadow-primary-500/30"
                              : "bg-white dark:bg-dark-card border border-slate-200 dark:border-dark-border text-slate-700 dark:text-slate-300 hover:border-primary-500"
                          }`}
                        >
                          {time}
                        </button>
                ...
                <div className="flex justify-end">
                  <button
                    ...
                    className="px-8 py-3 bg-slate-900 dark:bg-white text-white dark:text-slate-900 rounded-xl font-medium hover:bg-slate-800 dark:hover:bg-slate-100 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                  >
                    Next Step
                  </button>
                </div>
              ...
              >
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 bg-white dark:bg-dark-bg border border-slate-200 dark:border-dark-border rounded-xl text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary-500/50 focus:border-primary-500"
                      />
                    </div>
                    <div className="space-y-1.5">
                  ...
                  <div className="space-y-3">
                    <label className="text-sm font-medium text-slate-700 dark:text-slate-300">Meeting Format *</label>
                        ...
                        <label
                          ...
                          className={`flex items-center gap-3 p-4 border rounded-xl cursor-pointer transition-all ${
                            formData.meetingType === type.id
                              ...
                              : "border-slate-200 dark:border-dark-border bg-white dark:bg-dark-bg hover:border-primary-300"
                          }`}
                        >
                          <input
                            type="radio"
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <span className={`text-sm font-medium ${formData.meetingType === type.id ? "text-primary-900 dark:text-primary-100" : "text-slate-700 dark:text-slate-300"}`}>
                              {type.id}
                            </span>
                          </div>
                        </label>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 bg-white dark:bg-dark-bg border border-slate-200 dark:border-dark-border rounded-xl text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary-500/50 focus:border-primary-500 resize-none"
                    />
                  </div>
