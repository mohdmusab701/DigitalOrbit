...
export default function ContactPage() {
  return (
    <>
      ...
      <section className="py-16 lg:py-24 bg-white dark:bg-dark-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16">
            ...
            >
              <div className="p-6 lg:p-10 rounded-2xl bg-white dark:bg-dark-card border border-slate-100 dark:border-dark-border">
            ...
            >
              <div className="space-y-5">
                {contactInfo.map((info, index) => {
                  ...
                  const content = (
                    <div className="flex gap-4 p-5 rounded-2xl bg-white dark:bg-dark-card border border-slate-100 dark:border-dark-border hover:border-primary-200 dark:hover:border-primary-800 transition-all">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-medium text-slate-900 dark:text-white whitespace-pre-line">
                          {info.value}
                        </p>
                      </div>
                    </div>
      ...
      {/* Map Placeholder */}
      <section className="bg-white dark:bg-dark-bg pb-16 lg:pb-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="rounded-2xl overflow-hidden border border-slate-100 dark:border-dark-border"
          >
            <div className="relative h-72 lg:h-96 bg-slate-100 dark:bg-dark-card">
