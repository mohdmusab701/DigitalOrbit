          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              ...
              <div className="space-y-4 text-slate-500 dark:text-slate-400 leading-relaxed">
                <p>
                  Founded in 2025, DigitalOrbit started as a two-person studio with a bold vision: 
                ...
                <p>
                  Today, we&apos;re a team of 8+ engineers, designers, and strategists serving 200+ 
                  clients across 3 countries. We&apos;ve helped startups secure millions in funding, 
