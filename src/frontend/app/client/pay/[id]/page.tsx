...
export default function ClientPayPage() {
 ...
 className="px-6 py-2.5 bg-muted text-muted-foreground rounded-xl hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors font-medium"
 >
 Go to Dashboard
 </button>
 </div>
 ...
 <h2 className="text-2xl font-bold text-foreground mb-1">Complete Payment</h2>
 <p className="text-muted-foreground">Secure payment powered by Razorpay</p>
 </div>

 {/* Invoice Details */}
 <div className="bg-muted/50 rounded-2xl p-5 mb-6 space-y-3">
 ...
 <span className="text-sm text-muted-foreground">{invoice.projectId.projectName}</span>
 </div>
 )}
 ...
 <p className="text-muted-foreground mb-6">{errorMsg || "Something went wrong during the payment process."}</p>
