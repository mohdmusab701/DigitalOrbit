      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-24 right-4 sm:right-6 z-[9999] w-[calc(100%-2rem)] sm:w-[400px] h-[520px] bg-white dark:bg-dark-card rounded-2xl shadow-2xl shadow-black/20 dark:shadow-black/50 border border-slate-200/50 dark:border-dark-border/50 flex flex-col overflow-hidden"
          >
            {/* Header */}
            ...
            <div className="flex-1 overflow-y-auto px-4 py-4 space-y-3 scroll-smooth" id="chat-messages">
                  ...
                  <div
                    className={`max-w-[80%] px-3.5 py-2.5 rounded-2xl text-[13px] leading-relaxed ${
                      msg.role === "user"
                        ...
                        : "bg-slate-100 dark:bg-dark-bg/80 text-slate-800 dark:text-slate-200 rounded-bl-md border border-slate-200/50 dark:border-dark-border/30"
                    }`}
                  >
              ...
              {loading && (
                ...
                >
                  ...
                  <div className="bg-slate-100 dark:bg-dark-bg/80 border border-slate-200/50 dark:border-dark-border/30 px-4 py-3 rounded-2xl rounded-bl-md">
            ...
            {/* Input */}
            <div className="shrink-0 border-t border-slate-200/50 dark:border-dark-border/50 p-3 bg-white dark:bg-dark-card">
              <div className="flex items-center gap-2">
                <input
                  ...
                  disabled={loading}
                  className="flex-1 bg-slate-50 dark:bg-dark-bg border border-slate-200 dark:border-dark-border rounded-xl px-4 py-2.5 text-sm text-slate-900 dark:text-white placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-primary-500/30 focus:border-primary-500 transition-all disabled:opacity-60"
                  maxLength={2000}
                />
                <button
                  onClick={sendMessage}
