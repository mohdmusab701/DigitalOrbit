    ...
    >
      ...
      <div
        className={`relative h-full rounded-2xl overflow-hidden transition-all duration-300 hover:shadow-2xl ${
          plan.popular
            ? 'bg-white dark:bg-dark-card border-2 border-primary-500 dark:border-primary-600 shadow-xl shadow-primary-500/10 hover:shadow-primary-500/20'
            : 'bg-white dark:bg-dark-card border border-slate-200 dark:border-dark-border hover:border-primary-200 dark:hover:border-primary-800 hover:shadow-primary-500/5'
        }`}
      >
        <div className="p-8">
          {/* Plan Name */}
          ...
          <div className="mb-8">
            <div className="flex items-baseline gap-1">
              ...
              <span className={`text-4xl font-bold ${plan.popular ? 'gradient-text' : 'text-slate-900 dark:text-white'}`}>
                {plan.price}
              </span>
            </div>
          ...
          <Link
            ...
            className={`block w-full text-center py-3.5 px-6 rounded-xl font-semibold text-sm transition-all active:scale-95 mb-8 ${
              plan.popular
                ...
                : 'bg-slate-100 dark:bg-white/5 hover:bg-primary-50 dark:hover:bg-primary-900/20 text-slate-900 dark:text-white hover:text-primary-600 dark:hover:text-primary-400'
            }`}
          >
            {plan.cta}
          </Link>
