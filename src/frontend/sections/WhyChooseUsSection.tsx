...
export default function WhyChooseUsSection() {
 ...
 className="group flex gap-5 p-6 lg:p-8 rounded-2xl bg-card border border-border hover:border-primary-200 dark:hover:border-primary-800 transition-all duration-300 hover:shadow-xl hover:shadow-primary-500/5"
 >
