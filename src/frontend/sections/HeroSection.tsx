      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 lg:pt-32 pb-16 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.h1
            ...
            className="text-4xl sm:text-5xl lg:text-7xl font-bold text-slate-900 dark:text-white leading-[1.1] mb-6"
          >
            Build Smarter.{' '}
          ...
          <motion.p
            ...
            className="text-lg lg:text-xl text-slate-500 dark:text-slate-400 max-w-2xl mx-auto mb-10 leading-relaxed"
          >
          ...
          >
            ...
            <Link
              href="/portfolio"
              className="group inline-flex items-center gap-2 px-8 py-4 bg-white dark:bg-white/5 hover:bg-slate-50 dark:hover:bg-white/10 text-slate-900 dark:text-white font-semibold rounded-2xl border border-slate-200 dark:border-white/10 transition-all hover:shadow-lg"
            >
          ...
          <motion.div
            ...
            className="flex items-center justify-center gap-8 lg:gap-16 mt-16 pt-8 border-t border-slate-200/50 dark:border-white/10"
          >
            {[
