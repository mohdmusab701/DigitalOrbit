...
export default function AIServicesSection() {
 ...
 className="group relative flex flex-col h-full bg-card rounded-3xl border border-border p-8 overflow-hidden transition-all duration-500 hover:shadow-2xl hover:shadow-indigo-500/10 hover:-translate-y-1"
 >
 ...
 <h3 className="text-xl font-bold text-foreground mb-3 relative z-10 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors">
 {service.title}
 </h3>
 ...
 {/* CTA */}
 <div className="mt-auto relative z-10 pt-6 border-t border-border">
 <Link
 href="/contact"
