...
export default function AIShowcaseSection() {
  return (
    <section className="py-20 lg:py-32 bg-slate-50 dark:bg-dark-card/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-16">
          {aiShowcase.map((item, index) => (
            ...
            >
              <div className="relative rounded-3xl overflow-hidden bg-white dark:bg-dark-card border border-slate-200 dark:border-dark-border transition-all duration-500 hover:shadow-2xl hover:border-indigo-300 dark:hover:border-indigo-700 hover:-translate-y-1">
                {/* Visual Area */}
